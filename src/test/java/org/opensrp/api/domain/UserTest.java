...
public class UserTest {
    ...
    public void shouldTestConstructor() {
        ...
        final Object user3 = getInstance(clazz, "ooo-02we-98", "lieo", "preferredName", "password", "sonn", "Active", roles,
                permissions);
    ...
    public void testUserAttributes() {
        ...
        u.withAttribute("attr1", "strval").withAttribute("attr2", 2).withAttribute("attr3", true);
    ...
    public void testUserPermissions() {
        User user = new User("entity id 1").withUsername("username11").withPermission("view").withPermission("edit")
                .withPermission("add").withPermission("delete");
    ...
    public void testUserRole() {
        User user = new User("entity id 1").withUsername("username11").withRole("r1").withRole("r2");
    ...
    public void testUserActiveness() {
        User user = new User("entity id 1").withStatus("active");
