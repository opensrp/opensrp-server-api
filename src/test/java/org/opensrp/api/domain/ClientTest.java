...
public class ClientTest {
    ...
    public void shouldTestConstructor() {
        ...
        final Object obj1 = getInstance(clazz, "ooo-02we-98", "lieo", "daow", "sonn", new Date(), new Date(), true, true,
                "Male", "identifierType", "identifier");
        Affirm.affirmNotNull("Should have created an object", obj1);
        final Object obj3 = getInstance(clazz, "ooo-02we-98", "lieo", "daow", "sonn", new Date(), new Date(), true, true,
                "Male", addresses, identifiers, attributes);
        ...
        final Object obj4 = getInstance(clazz, "ooo-02we-98", "lieo", "daow", "sonn", new Date(), new Date(), true, true,
                "Male");
