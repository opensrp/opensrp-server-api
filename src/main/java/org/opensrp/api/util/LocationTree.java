 ...
 * creating a Tree for {@link Location}. The key is the locationId and label is name of
 * {@link Location} and the data for tree node is location object itself. Each node has locationId
 * if its parent location and has a {@link TreeNode} map of children of the location. This way it
