...
public class Event {
    ...
    public void i_Set_POST_event_service_api_endpoint() {
        ...
        RequestPayLoad = Events.addEvent(EnvGlobals.clientBasicEntityID_uuid,EnvGlobals.clientAddress_uuid,EnvGlobals.clientId_uuid,EnvGlobals.teamName,EnvGlobals.teamUuid,EnvGlobals.eventBasicEntityID_uuid,EnvGlobals.eventLocation_uuid ,EnvGlobals.formSubmissionId_uuid,EnvGlobals.eventId_uuid, ConfigProperties.username);
    }
